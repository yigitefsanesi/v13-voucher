...
run: async (client, message, args, embed, prefix) => { 
    ...
    {
    message.react(red)
    message.lineReply(`\`${prefix}isim <@Carloza/ID> <Isim> <Yaş>\``).then(x=>x.delete({timeout:5000})) 
    return }
...
.setFooter(`Üyesinin önceki isimlerine <!isimler @Carloza/ID> komutuyla bakarak kayıt işlemini gerçekleştirmeniz önerilir.`))
